"""Built-in Tailwind v3 default token values."""
...
# ---------------------------------------------------------------------------
# Tailwind default spacing scale (in px)
# ---------------------------------------------------------------------------
...
# Reverse lookup: px value -> token name
SPACING_BY_PX: dict[float, str] = {v: k for k, v in SPACING.items()}
...
FONT_SIZES_BY_PX: dict[float, str] = {v: k for k, v in FONT_SIZES.items()}

# ---------------------------------------------------------------------------
# Tailwind default border-radius
# ---------------------------------------------------------------------------
BORDER_RADIUS: dict[str, float] = {
    "none": 0, "sm": 2, "DEFAULT": 4, "md": 6, "lg": 8,
    "xl": 12, "2xl": 16, "3xl": 24, "full": 9999,
}

# ---------------------------------------------------------------------------
# Tailwind default z-index
# ---------------------------------------------------------------------------
...
OPACITY: dict[str, float] = {
    ...
    "80": 0.8, "85": 0.85, "90": 0.9, "95": 0.95, "100": 1.0,
}
